package com.example.cfp2.controller;

/**
 * UC1 :- Create a Rest Controller to demonstrate the various HTTP Methods and respond hello messages to the com.example.cfp2.model.User.
 ...
 *        - Create com.example.cfp2.model.User DTO Bean with firstName and lastName as attributes.
 *        - Use CURL to demonstrate the REST API Call
...
import com.example.cfp2.model.User;
